...
from 1-select_formal_outfit import select_formal_outfit
from 2-select_top import select_top
from 3-select_bottom import select_bottom
import random

def select_outfit(mode=None, theme):
    """Calls select_top, select_bottom and other necessary functions"""

if input_dict["theme"] == 'formal':
